...
export const generateBadgeUrl = (name: TechnologyName) => {
  ...
  const url = `https://img.shields.io/badge/${technology.badgeName}-${technology.badgeColor ?? '20232A'}?logo=${technology.logoName}&logoColor=${technology.logoColor}&style=for-the-badge`;
  return url;
};